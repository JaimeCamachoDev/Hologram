...
Shader "Hologram Shader IA Lit Hair"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float fresnelNdotV571 = dot( WorldNormal, WorldViewDirection );
				...
				float3 maincolor232 = ( _MainColor.rgb * tex2DNode605.a );
				float3 fresnelcolor580 = ( ( fresnelNode571 + NormalAffect594 ) * ( _FresnelColor.rgb * maincolor232 ) );
				...
				float2 temp_cast_1 = ((WorldPosition.y*_Line1InvertedThickness1 + ( mulTime3_g178 + 0.0 ))).xx;
				float clampResult42_g178 = clamp( ( ( tex2D( _Line3, temp_cast_1 ).r - 0.0 ) * _Line1Hardness1 ) , 0.0 , 1.0 );
				float temp_output_638_0 = ( clampResult42_g178 * _Line1Alpha1 );
				float4 appendResult683 = (float4(0.0 , 0.0 , 0.0 , temp_output_638_0));
				float mulTime685 = _TimeParameters.x * _Line2Speed;
				float Line_2734 = frac( ( ( WorldPosition.y * _Line2Frequency ) + mulTime685 ) );
				...
				float3 temp_output_788_0 = ( _Coloremissive + ( ColorGlitch689 * ( fresnelcolor580 + grain268 + maincolor232 + (line_color650).xyz ) ) );
				
				float3 temp_cast_2 = (NormalAffect594).xxx;
				
				float2 uv_MAS = input.ase_texcoord9.xy * _MAS_ST.xy + _MAS_ST.zw;
				float4 tex2DNode784 = tex2D( _MAS, uv_MAS );
				
				float alphamask402 = tex2DNode605.a;
				float clampResult677 = clamp( ( alphamask402 * (line_color650).w ) , 0.0 , 1.0 );
				

				float3 BaseColor = temp_output_788_0;
				float3 Normal = temp_cast_2;
				float3 Emission = temp_output_788_0;
				float3 Specular = 0.5;
				float Metallic = tex2DNode784.r;
				float Smoothness = tex2DNode784.b;
				float Occlusion = tex2DNode784.g;
				float Alpha = clampResult677;
				float AlphaClipThreshold = ( alphamask402 * _Alpha );
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float alphamask402 = tex2DNode605.a;
				float mulTime3_g178 = _TimeParameters.x * _Line1Speed1;
				float2 temp_cast_0 = ((WorldPosition.y*_Line1InvertedThickness1 + ( mulTime3_g178 + 0.0 ))).xx;
				float clampResult42_g178 = clamp( ( ( tex2D( _Line3, temp_cast_0 ).r - 0.0 ) * _Line1Hardness1 ) , 0.0 , 1.0 );
				float temp_output_638_0 = ( clampResult42_g178 * _Line1Alpha1 );
				float4 appendResult683 = (float4(0.0 , 0.0 , 0.0 , temp_output_638_0));
				float3 maincolor232 = ( _MainColor.rgb * tex2DNode605.a );
				float mulTime685 = _TimeParameters.x * _Line2Speed;
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input ) : SV_Target
			{
				...
				float mulTime3_g178 = _TimeParameters.x * _Line1Speed1;
				float2 temp_cast_0 = ((ase_positionWS.y*_Line1InvertedThickness1 + ( mulTime3_g178 + 0.0 ))).xx;
				float clampResult42_g178 = clamp( ( ( tex2D( _Line3, temp_cast_0 ).r - 0.0 ) * _Line1Hardness1 ) , 0.0 , 1.0 );
				float temp_output_638_0 = ( clampResult42_g178 * _Line1Alpha1 );
				float4 appendResult683 = (float4(0.0 , 0.0 , 0.0 , temp_output_638_0));
				float3 maincolor232 = ( _MainColor.rgb * tex2DNode605.a );
				...
				surfaceDescription.Alpha = clampResult677;
				surfaceDescription.AlphaClipThreshold = ( alphamask402 * _Alpha );
	...
	Fallback "Hologram Shader IA Lit Hair"
}
/*ASEBEGIN
Version=19801
...
Node;AmplifyShaderEditor.Vector3Node;769;-640,-32;Inherit;False;Property;_GlichSpeed;Glich Speed;24;0;Create;True;0;0;0;False;0;False;1,-1,1;0.1,-0.1,0.01;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RangedFloatNode;151;-432,-176;Inherit;False;Property;_RandomGlitchTiling;Random Glitch Tiling;26;0;Create;True;0;0;0;False;0;False;2.83;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;613;-672,-1072;Inherit;False;Property;_Line2Speed;Line 2 Speed;15;0;Create;True;0;0;0;False;0;False;-1;0.1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;738;-704,-1152;Inherit;False;Property;_Line2Frequency;Line 2 Frequency;16;0;Create;True;0;0;0;False;0;False;-1;0.1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;549;-720,-4032;Inherit;False;670.612;448.8643;Color;5;232;604;605;231;402;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.SamplerNode;605;-704,-3776;Inherit;True;Property;_MainTexture;Main Texture;1;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.ColorNode;231;-704,-3984;Inherit;False;Property;_MainColor;Main Color;0;1;[HDR];Create;True;0;0;0;False;0;False;0.620945,1.420074,3.953349,0.05098039;1,1,1,1;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.RangedFloatNode;225;-96,368;Inherit;False;Property;_RandomGlitchConstant;Random Glitch Constant;25;0;Create;True;0;0;0;False;0;False;0.4889122;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;604;-416,-3856;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;623;-688,-2496;Inherit;False;Property;_Line1InvertedThickness1;Line 1 Inverted Thickness;13;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;620;-592,-2656;Inherit;False;Property;_Line1Hardness1;Line 1 Hardness;12;0;Create;True;0;0;0;False;0;False;1.45;1.45;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;619;-592,-2736;Inherit;False;Property;_Line1Speed1;Line 1 Speed;10;0;Create;True;0;0;0;False;0;False;-3.57;-3.57;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;621;-624,-3152;Inherit;True;Property;_Line3;Line 1;9;2;[Header];[NoScaleOffset];Create;True;2;LINES;_;0;0;False;0;False;88eb97e78f86c604bb00864c0dbeffc1;ef301d4822ac111469bda406e1b4bc7c;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;634;-16,-3040;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;633;-592,-2160;Inherit;False;Property;_Line2Alpha;Line 2 Alpha;17;0;Create;True;0;0;0;False;0;False;0.1;100;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;632;-224,-2736;Inherit;False;Property;_Line1Alpha1;Line 1 Alpha;14;0;Create;True;0;0;0;False;0;False;0.15;-0.1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector3Node;84;-704,-912;Inherit;False;Property;_GlitchLine2Offset;Glitch Line 2 Offset;21;1;[Header];Create;True;2;GLITCH LINE 2;_;0;0;False;0;False;0.5,0,0;0.03,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.Vector3Node;121;1088,-256;Inherit;False;Property;_RandomGlitchOffset;Random Glitch Offset;22;0;Create;True;0;0;0;False;0;False;-0.5,0,0;-0.1,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RangedFloatNode;128;1488,624;Inherit;False;Property;_RandomGlitchAmount;Random Glitch Amount;23;0;Create;True;0;0;0;False;0;False;0.089;0.1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;700;-736,-2000;Inherit;False;1108;626.95;Vertex Position;4;519;159;492;494;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;494;-672,-1712;Inherit;False;493;randomglitch;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;492;-640,-1808;Inherit;False;491;lineglitch;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;402;-384,-3648;Inherit;False;alphamask;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;654;1552,-3568;Inherit;False;650;line_color;1;0;OBJECT;;False;1;FLOAT4;0
Node;AmplifyShaderEditor.SimpleAddOpNode;159;-112,-1792;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;406;2080,-3664;Inherit;False;402;alphamask;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.ComponentMaskNode;657;1808,-3504;Inherit;False;False;False;False;True;1;0;FLOAT4;0,0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;694;-720,-6336;Inherit;False;2211.089;540.0215;Color Glitcht;14;689;181;175;184;183;174;176;168;166;167;163;164;165;160;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;564;-720,-4816;Inherit;False;1093.118;409.6844;Fresnel;9;580;578;582;574;583;567;568;571;789;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;794;2176,-3504;Inherit;False;Property;_Alpha;Alpha;28;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ClampOpNode;677;2464,-3664;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;585;-656,-5184;Inherit;False;Property;_NormalScale;NormalScale;5;0;Create;True;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;584;-464,-5232;Inherit;True;Property;_NormalMap;NormalMap;2;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.RangedFloatNode;589;-16,-4928;Inherit;False;Property;_NormalAffect;NormalAffect;6;0;Create;True;0;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.IntNode;602;-704,-5504;Inherit;False;Property;_GrainScale;Grain Scale;19;0;Create;True;0;0;0;False;0;False;1000;1000;False;0;1;INT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;567;-688,-4624;Inherit;False;Property;_FresnelPower;Fresnel Power;8;0;Create;True;0;0;0;False;0;False;2;0.56;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;568;-688,-4704;Inherit;False;Property;_FresnelScale;Fresnel Scale;7;1;[Header];Create;True;2;FRESNEL;_;0;0;False;0;False;1;4.09;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;582;-736,-4496;Inherit;False;232;maincolor;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.ColorNode;790;-896,-4624;Inherit;False;Property;_FresnelColor;Fresnel Color;27;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.RangedFloatNode;270;-160,-5456;Inherit;False;Property;_GrainAffect;Grain Affect;18;1;[Header];Create;True;2;GRAIN;_;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;789;-368,-4496;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.LerpOp;269;192,-5520;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;578;-48,-4592;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;184;736,-5904;Inherit;False;Property;_GlitchColorAffect;Glitch Color Affect;20;1;[Header];Create;True;2;GLITCH COLOR ;_;0;0;False;0;False;0.5;0.109;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;617;-624,-2576;Inherit;False;Property;_Line1Frequency1;Line 1 Frequency;11;0;Create;True;0;0;0;False;0;False;100;101;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;788;2608,-3824;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.ColorNode;787;2064,-4096;Inherit;False;Property;_Coloremissive;Color emissive;4;1;[HDR];Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;False;0;6;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;185;2320,-3808;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;695;2416,-3008;Inherit;False;519;ModifiedVertexPosition;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SamplerNode;784;2384,-3248;Inherit;True;Property;_MAS;MAS;3;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.GetLocalVarNode;772;2528,-4256;Inherit;False;594;NormalAffect;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;793;2464,-3536;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;773;2800,-3808;Float;False;False;-1;3;UnityEditor.ShaderGraphLitGUI;0;12;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ExtraPrePass;0;0;ExtraPrePass;5;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;0;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;775;2800,-3808;Float;False;False;-1;3;UnityEditor.ShaderGraphLitGUI;0;12;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ShadowCaster;0;2;ShadowCaster;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;True;False;False;False;False;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;True;1;LightMode=ShadowCaster;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;776;2800,-3808;Float;False;False;-1;3;UnityEditor.ShaderGraphLitGUI;0;12;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;DepthOnly;0;3;DepthOnly;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;True;True;False;False;False;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;False;False;True;1;LightMode=DepthOnly;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;777;2800,-3808;Float;False;False;-1;3;UnityEditor.ShaderGraphLitGUI;0;12;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Meta;0;4;Meta;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Meta;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;778;2800,-3808;Float;False;False;-1;3;UnityEditor.ShaderGraphLitGUI;0;12;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Universal2D;0;5;Universal2D;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;True;1;1;False;;1;False;;1;1;False;;10;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=Universal2D;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;779;2800,-3808;Float;False;False;-1;3;UnityEditor.ShaderGraphLitGUI;0;12;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;DepthNormals;0;6;DepthNormals;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;True;1;LightMode=DepthNormals;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;780;2800,-3808;Float;False;False;-1;3;UnityEditor.ShaderGraphLitGUI;0;12;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;GBuffer;0;7;GBuffer;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;True;1;1;False;;1;False;;1;1;False;;10;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalGBuffer;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;781;2800,-3808;Float;False;False;-1;3;UnityEditor.ShaderGraphLitGUI;0;12;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;SceneSelectionPass;0;8;SceneSelectionPass;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;2;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=SceneSelectionPass;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;782;2800,-3808;Float;False;False;-1;3;UnityEditor.ShaderGraphLitGUI;0;12;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ScenePickingPass;0;9;ScenePickingPass;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Picking;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;783;2800,-3808;Float;False;False;-1;3;UnityEditor.ShaderGraphLitGUI;0;12;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;MotionVectors;0;10;MotionVectors;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;False;False;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=MotionVectors;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;774;2800,-3808;Float;False;True;-1;3;UnityEditor.ShaderGraphLitGUI;0;12;Hologram Shader IA Lit Hair;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;21;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;2;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;2;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;True;1;1;False;;1;False;;1;1;False;;10;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForward;False;False;0;Hologram Shader IA Lit Hair;0;0;Standard;45;Lighting Model;0;0;Workflow;1;0;Surface;1;638797090125099715;  Refraction Model;0;0;  Blend;2;638823721888766217;Two Sided;0;638823721538360856;Alpha Clipping;1;638823804422841988;  Use Shadow Threshold;0;0;Fragment Normal Space,InvertActionOnDeselection;0;0;Forward Only;0;0;Transmission;0;0;  Transmission Shadow;0.5,False,;0;Translucency;0;0;  Translucency Strength;1,False,;0;  Normal Distortion;0.5,False,;0;  Scattering;2,False,;0;  Direct;0.9,False,;0;  Ambient;0.1,False,;0;  Shadow;0.5,False,;0;Cast Shadows;0;638797093586149105;Receive Shadows;0;638797093589362460;Receive SSAO;0;638797093594332272;Motion Vectors;0;638797093599933489;  Add Precomputed Velocity;0;0;GPU Instancing;0;638797093614189727;LOD CrossFade;0;638797093618675362;Built-in Fog;0;638823794289333335;_FinalColorxAlpha;0;0;Meta Pass;1;0;Override Baked GI;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Write Depth;0;0;  Early Z;0;0;Vertex Position,InvertActionOnDeselection;1;0;Debug Display;0;0;Clear Coat;0;0;0;11;False;True;False;True;True;True;True;True;True;True;False;False;;False;0
...
WireConnection;652;1;657;0
WireConnection;677;0;652;0

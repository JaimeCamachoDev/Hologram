	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 uv_Emisive = input.ase_texcoord9.xy * _Emisive_ST.xy + _Emisive_ST.zw;
				...
				float fresnelNdotV569 = dot( WorldNormal, WorldViewDirection );
				...
				float simplePerlin3D264 = snoise( (WorldPosition*temp_cast_1 + mulTime273) );
				...
				float2 temp_cast_2 = ((WorldPosition.y*_Line1Frequency1 + ( mulTime3_g178 + 0.0 ))).xx;
				...
				float clampResult768 = clamp( ( WorldPosition.y + _AlphaHeight ) , 0.0 , 1.0 );
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float grain268 = lerpResult269;
				float mulTime3_g178 = _TimeParameters.x * _Line1Speed1;
				float2 temp_cast_1 = ((WorldPosition.y*_Line1Frequency1 + ( mulTime3_g178 + 0.0 ))).xx;
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_Target
			{
				...
				float2 uv_Emisive = input.ase_texcoord4.xy * _Emisive_ST.xy + _Emisive_ST.zw;
				float mulTime165 = _TimeParameters.x * -15.0;
				float mulTime167 = _TimeParameters.x * -0.5;
				float2 appendResult168 = (float2((0.0*223.0 + mulTime165) , mulTime167));
				float simplePerlin2D176 = snoise( appendResult168 );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_Target
			{
				...
				float2 uv_Emisive = input.ase_texcoord2.xy * _Emisive_ST.xy + _Emisive_ST.zw;
				float mulTime165 = _TimeParameters.x * -15.0;
				float mulTime167 = _TimeParameters.x * -0.5;
				float2 appendResult168 = (float2((0.0*223.0 + mulTime165) , mulTime167));
				float simplePerlin2D176 = snoise( appendResult168 );
		...
		Pass
		{
						 ...
						 )
			{
				...
				float3 ase_viewVectorWS = ( _WorldSpaceCameraPos.xyz - WorldPosition );
				float3 ase_viewDirWS = normalize( ase_viewVectorWS );
				float fresnelNdotV571 = dot( WorldNormal, ase_viewDirWS );
				float fresnelNode571 = ( 0.0 + _FresnelScale * pow( max( 1.0 - fresnelNdotV571 , 0.0001 ), _FresnelPower ) );
				float2 uv_MainTexture = input.ase_texcoord5.xy * _MainTexture_ST.xy + _MainTexture_ST.zw;
				float4 tex2DNode605 = tex2D( _MainTexture, uv_MainTexture );
				float3 maincolor232 = ( _MainColor.rgb * tex2DNode605.rgb );
				float fresnelNdotV569 = dot( WorldNormal, ase_viewDirWS );
				float fresnelNode569 = ( 0.0 + _FresnelAlphaScale * pow( max( 1.0 - fresnelNdotV569 , 0.0001 ), _FresnelAlphaPower ) );
				float clampResult577 = clamp( ( fresnelNode569 + NormalAffect594 ) , 0.0 , 1.0 );
				float3 fresnelcolor580 = ( ( fresnelNode571 + NormalAffect594 ) * ( _FresnelColor.rgb * maincolor232 ) * clampResult577 );
				float3 temp_cast_1 = _GrainScale;
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input ) : SV_Target
			{
				...
				float grain268 = lerpResult269;
				float mulTime3_g178 = _TimeParameters.x * _Line1Speed1;
				float2 temp_cast_1 = ((ase_positionWS.y*_Line1Frequency1 + ( mulTime3_g178 + 0.0 ))).xx;
				float clampResult42_g178 = clamp( ( ( tex2D( _Line3, temp_cast_1 ).r - _Line1InvertedThickness1 ) * _Line1Hardness1 ) , 0.0 , 1.0 );
				float temp_output_638_0 = ( clampResult42_g178 * _Line1Alpha1 );
				float4 appendResult683 = (float4(0.0 , 0.0 , 0.0 , temp_output_638_0));
				float mulTime685 = _TimeParameters.x * _Line2Speed;
				...
				float4 appendResult644 = (float4(( (( maincolor232 * float3( 0,0,0 ) )).xyz * (( maincolor232 * Line_2734 )).xyz ) , ( temp_output_638_0 * ( Line_2734 * _Line2Alpha ) )));
				float4 line_color650 = ( appendResult683 + appendResult644 );
				float clampResult768 = clamp( ( ase_positionWS.y + _AlphaHeight ) , 0.0 , 1.0 );
				float lerpResult400 = lerp( 0.0 , tex2DNode605.a , clampResult768);
				float alphamask402 = lerpResult400;
				float fresnelalpha579 = clampResult577;
				float clampResult677 = clamp( ( fresnelalpha579 + (line_color650).w ) , 0.0 , 1.0 );
...
Node;AmplifyShaderEditor.RangedFloatNode;613;-672,-1072;Inherit;False;Property;_Line2Speed;Line 2 Speed;19;0;Create;True;0;0;0;False;0;False;-1;0.1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;738;-704,-1152;Inherit;False;Property;_Line2Frequency;Line 2 Frequency;20;0;Create;True;0;0;0;False;0;False;-1;0.1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.WorldPosInputsNode;687;-672,-1296;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.Vector3Node;769;-640,-32;Inherit;False;Property;_GlichSpeed;Glich Speed;28;0;Create;True;0;0;0;False;0;False;1,-1,1;0.1,-0.1,0.01;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RangedFloatNode;151;-432,-176;Inherit;False;Property;_RandomGlitchTiling;Random Glitch Tiling;30;0;Create;True;0;0;0;False;0;False;2.83;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;585;-656,-5184;Inherit;False;Property;_NormalScale;NormalScale;7;0;Create;True;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;584;-464,-5232;Inherit;True;Property;_NormalMap;NormalMap;3;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.RangedFloatNode;589;-16,-4928;Inherit;False;Property;_NormalAffect;NormalAffect;8;0;Create;True;0;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;623;-688,-2496;Inherit;False;Property;_Line1InvertedThickness1;Line 1 Inverted Thickness;17;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;617;-624,-2576;Inherit;False;Property;_Line1Frequency1;Line 1 Frequency;15;0;Create;True;0;0;0;False;0;False;100;101;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;620;-592,-2656;Inherit;False;Property;_Line1Hardness1;Line 1 Hardness;16;0;Create;True;0;0;0;False;0;False;1.45;1.45;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;619;-592,-2736;Inherit;False;Property;_Line1Speed1;Line 1 Speed;14;0;Create;True;0;0;0;False;0;False;-3.57;-3.57;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;621;-624,-3152;Inherit;True;Property;_Line3;Line 1;13;2;[Header];[NoScaleOffset];Create;True;2;LINES;_;0;0;False;0;False;88eb97e78f86c604bb00864c0dbeffc1;ef301d4822ac111469bda406e1b4bc7c;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;225;-96,368;Inherit;False;Property;_RandomGlitchConstant;Random Glitch Constant;29;0;Create;True;0;0;0;False;0;False;0.4889122;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;633;-592,-2160;Inherit;False;Property;_Line2Alpha;Line 2 Alpha;21;0;Create;True;0;0;0;False;0;False;0.1;100;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;632;-224,-2736;Inherit;False;Property;_Line1Alpha1;Line 1 Alpha;18;0;Create;True;0;0;0;False;0;False;0.15;-0.1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.IntNode;602;-704,-5504;Inherit;False;Property;_GrainScale;Grain Scale;23;0;Create;True;0;0;0;False;0;False;1000;1000;False;0;1;INT;0
Node;AmplifyShaderEditor.RangedFloatNode;566;-672,-4192;Inherit;False;Property;_FresnelAlphaPower;Fresnel Alpha Power;12;0;Create;True;0;0;0;False;0;False;2;0.49;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;565;-672,-4272;Inherit;False;Property;_FresnelAlphaScale;Fresnel Alpha Scale;11;0;Create;True;0;0;0;False;0;False;1;0.59;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;522;-720,-3552;Inherit;False;873.6426;255.0996;Alpha ;6;740;402;400;768;745;742;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;567;-688,-4624;Inherit;False;Property;_FresnelPower;Fresnel Power;10;0;Create;True;0;0;0;False;0;False;2;0.56;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;568;-688,-4704;Inherit;False;Property;_FresnelScale;Fresnel Scale;9;1;[Header];Create;True;2;FRESNEL;_;0;0;False;0;False;1;4.09;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector3Node;84;-704,-912;Inherit;False;Property;_GlitchLine2Offset;Glitch Line 2 Offset;25;1;[Header];Create;True;2;GLITCH LINE 2;_;0;0;False;0;False;0.5,0,0;0.03,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.Vector3Node;121;1088,-256;Inherit;False;Property;_RandomGlitchOffset;Random Glitch Offset;26;0;Create;True;0;0;0;False;0;False;-0.5,0,0;-0.1,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RangedFloatNode;742;-704,-3376;Inherit;False;Property;_AlphaHeight;Alpha Height;1;0;Create;True;0;0;0;False;0;False;0.76;-0.41;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;582;-736,-4496;Inherit;False;232;maincolor;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.ColorNode;790;-896,-4624;Inherit;False;Property;_FresnelColor;Fresnel Color;31;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.RangedFloatNode;270;-160,-5456;Inherit;False;Property;_GrainAffect;Grain Affect;22;1;[Header];Create;True;2;GRAIN;_;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;128;1488,624;Inherit;False;Property;_RandomGlitchAmount;Random Glitch Amount;27;0;Create;True;0;0;0;False;0;False;0.089;0.1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;184;736,-5904;Inherit;False;Property;_GlitchColorAffect;Glitch Color Affect;24;1;[Header];Create;True;2;GLITCH COLOR ;_;0;0;False;0;False;0.5;0.109;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;772;2544,-3872;Inherit;False;594;NormalAffect;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;785;2096,-3328;Inherit;True;Property;_Emisive;Emisive;4;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;786;2480,-3168;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.ColorNode;787;2128,-3072;Inherit;False;Property;_Coloremissive;Color emissive;6;1;[HDR];Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;False;0;6;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SimpleAddOpNode;788;2624,-3392;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT4;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.SamplerNode;784;2224,-3504;Inherit;True;Property;_MAS;MAS;5;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;791;2800,-3456;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;792;2800,-3344;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ComponentMaskNode;680;2560,-3712;Inherit;False;False;False;False;True;1;0;FLOAT4;0,0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;774;2800,-3808;Float;False;True;-1;3;UnityEditor.ShaderGraphLitGUI;0;12;Hologram Shader IA Lit;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;21;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;2;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;True;1;5;False;;10;False;;1;1;False;;10;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForward;False;False;0;;0;0;Standard;45;Lighting Model;0;0;Workflow;1;0;Surface;1;638797090125099715;  Refraction Model;0;0;  Blend;0;0;Two Sided;1;0;Alpha Clipping;0;638797090093761643;  Use Shadow Threshold;0;0;Fragment Normal Space,InvertActionOnDeselection;0;0;Forward Only;0;0;Transmission;0;0;  Transmission Shadow;0.5,False,;0;Translucency;0;0;  Translucency Strength;1,False,;0;  Normal Distortion;0.5,False,;0;  Scattering;2,False,;0;  Direct;0.9,False,;0;  Ambient;0.1,False,;0;  Shadow;0.5,False,;0;Cast Shadows;0;638797093586149105;Receive Shadows;0;638797093589362460;Receive SSAO;0;638797093594332272;Motion Vectors;0;638797093599933489;  Add Precomputed Velocity;0;0;GPU Instancing;0;638797093614189727;LOD CrossFade;0;638797093618675362;Built-in Fog;1;638797093636280899;_FinalColorxAlpha;0;0;Meta Pass;1;0;Override Baked GI;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Write Depth;0;0;  Early Z;0;0;Vertex Position,InvertActionOnDeselection;1;0;Debug Display;0;0;Clear Coat;0;0;0;11;False;True;False;True;True;True;True;True;True;True;False;False;;False;0
...
ASEEND*/
//CHKSM=DD5BAD6754DB4603ADC450FED49A5BFA04AE0330
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 uv_Mask2 = input.ase_texcoord6.xy * _Mask2_ST.xy + _Mask2_ST.zw;
				...
				float dotResult4 = dot( ase_normalWS , WorldViewDirection );
...
ASEEND*/
//CHKSM=1BFC7D641AE312CF588D1F4A72ECB8BC58EAAB20